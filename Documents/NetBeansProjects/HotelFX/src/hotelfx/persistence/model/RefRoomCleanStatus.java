...
/**
 * RefRoomCleanStatus generated by hbm2java
 */
public class RefRoomCleanStatus implements java.io.Serializable {

    private final IntegerProperty idstatus;
    private final StringProperty statusName;
    private final StringProperty statusNote;

    public RefRoomCleanStatus() {
    ...
    public RefRoomCleanStatus(int idstatus) {
        this();
        idstatusProperty().set(idstatus);
    }

    public RefRoomCleanStatus(int idstatus, String statusName, String statusNote) {
        this();
        idstatusProperty().set(idstatus);
    ...
    public RefRoomCleanStatus(RefRoomCleanStatus refRoomCleanStatus) {
        this();
        idstatusProperty().set(refRoomCleanStatus.getIdstatus());
        statusNameProperty().set(refRoomCleanStatus.getStatusName());
        statusNoteProperty().set(refRoomCleanStatus.getStatusNote());

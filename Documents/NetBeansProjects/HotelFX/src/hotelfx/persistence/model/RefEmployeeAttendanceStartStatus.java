...
/**
 * RefEmployeeAttendanceStartStatus generated by hbm2java
 */
public class RefEmployeeAttendanceStartStatus implements java.io.Serializable {
    ...
    public RefEmployeeAttendanceStartStatus() {
    ...
    public RefEmployeeAttendanceStartStatus(int idstatus) {
        this();
        idstatusProperty().set(idstatus);
    }

    public RefEmployeeAttendanceStartStatus(int idstatus, String statusName, String statusNote, Set tblCalendarEmployeeAttendances) {
        this();
        idstatusProperty().set(idstatus);
    ...
    public RefEmployeeAttendanceStartStatus(RefEmployeeAttendanceStartStatus refEmployeeAttendanceStartStatus) {
        this();
        idstatusProperty().set(refEmployeeAttendanceStartStatus.getIdstatus());
        statusNameProperty().set(refEmployeeAttendanceStartStatus.getStatusName());
        statusNoteProperty().set(refEmployeeAttendanceStartStatus.getStatusNote());

        this.tblCalendarEmployeeAttendances = refEmployeeAttendanceStartStatus.getTblCalendarEmployeeAttendances();
    }

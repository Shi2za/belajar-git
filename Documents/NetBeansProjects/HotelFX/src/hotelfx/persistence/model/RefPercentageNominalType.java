...
/**
 * RefPercentageNominalType generated by hbm2java
 */
public class RefPercentageNominalType implements java.io.Serializable {
    ...
    public RefPercentageNominalType() {
    ...
    public RefPercentageNominalType(int idtype) {
        this();
        idtypeProperty().set(idtype);
    }

    public RefPercentageNominalType(int idtype, String typeName, String typeNote, Set tblBankEventCards) {
        this();
        idtypeProperty().set(idtype);
    ...
    public RefPercentageNominalType(RefPercentageNominalType refPercentageNominalType) {
        this();
        idtypeProperty().set(refPercentageNominalType.getIdtype());
        typeNameProperty().set(refPercentageNominalType.getTypeName());
        typeNoteProperty().set(refPercentageNominalType.getTypeNote());

        this.tblBankEventCards = refPercentageNominalType.getTblBankEventCards();
    }

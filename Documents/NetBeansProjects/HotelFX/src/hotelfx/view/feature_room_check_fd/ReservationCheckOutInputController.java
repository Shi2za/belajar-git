...
public class ReservationCheckOutInputController implements Initializable {
    ...
    private void dataCheckOutSaveHandle() {
        if (checkDataInputDataCheckOut()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if (roomStatusFDController.getServiceRV2().updateDataReservationRoomTypeDetailCheckOut(
                        dummySelectedData,
    ...
    public ReservationCheckOutInputController(RoomStatusFDController parentController) {

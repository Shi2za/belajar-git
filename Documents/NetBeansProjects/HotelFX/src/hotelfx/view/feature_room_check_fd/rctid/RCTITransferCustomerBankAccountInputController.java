...
public class RCTITransferCustomerBankAccountInputController implements Initializable {
    ...
    private void initDataCustomerBankAccountPopup() {
        ...
        ObservableList<TblBank> bankItems = FXCollections.observableArrayList(rctiTransferController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getAllDataBank());
    ...
    private void dataCustomerBankAccountSaveHandle() {
        if (checkDataInputDataCustomerBankAccount()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if (rctiTransferController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().insertDataCustomerBankAccount(dummySelectedData) != null) {
                    ...
                    rctiTransferController.selectedDataCustomerBankAccount = rctiTransferController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getDataCustomerBankAccount(dummySelectedData.getIdrelation());
                    rctiTransferController.selectedDataCustomerBankAccount.setTblCustomer(rctiTransferController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getCustomer(rctiTransferController.selectedDataCustomerBankAccount.getTblCustomer().getIdcustomer()));
                    rctiTransferController.selectedDataCustomerBankAccount.setTblBankAccount(rctiTransferController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getBankAccount(rctiTransferController.selectedDataCustomerBankAccount.getTblBankAccount().getIdbankAccount()));
                    rctiTransferController.getParentController().getParentController().getParentController().selectedDataTransactionWithTransfer.setTblBankAccountBySenderBankAccount(rctiTransferController.selectedDataCustomerBankAccount.getTblBankAccount());
                    //close form data customer bank account
                    rctiTransferController.dialogStage.close();
                } else {
                    ClassMessage.showFailedInsertingDataMessage(rctiTransferController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getErrorMessage(), rctiTransferController.dialogStage);
                }
            }
        } else {

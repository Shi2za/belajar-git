...
public class RCTIGuaranteePaymentPartnerBankAccountInputController implements Initializable {
    ...
    private void initDataPartnerBankAccountPopup() {
        ...
        ObservableList<TblBank> bankItems = FXCollections.observableArrayList(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getAllDataBank());
    ...
    private void dataPartnerBankAccountSaveHandle() {
        if (checkDataInputDataPartnerBankAccount()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if (rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().insertDataPartnerBankAccount(dummySelectedData) != null) {
                    ...
                    rctiGuaranteePaymentController.selectedDataPartnerBankAccount = rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getDataPartnerBankAccount(dummySelectedData.getIdrelation());
                    rctiGuaranteePaymentController.selectedDataPartnerBankAccount.setTblPartner(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getPartner(rctiGuaranteePaymentController.selectedDataPartnerBankAccount.getTblPartner().getIdpartner()));
                    rctiGuaranteePaymentController.selectedDataPartnerBankAccount.setTblBankAccount(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getBankAccount(rctiGuaranteePaymentController.selectedDataPartnerBankAccount.getTblBankAccount().getIdbankAccount()));
                    rctiGuaranteePaymentController.getParentController().getParentController().getParentController().selectedDataTransactionWithGuaranteePayment.setTblBankAccountBySenderBankAccount(rctiGuaranteePaymentController.selectedDataPartnerBankAccount.getTblBankAccount());
                    //close form data partner bank account
                    rctiGuaranteePaymentController.dialogStage.close();
                } else {
                    ClassMessage.showFailedInsertingDataMessage(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getParentController().getServiceRV2().getErrorMessage(), rctiGuaranteePaymentController.dialogStage);
                }
            }
        } else {

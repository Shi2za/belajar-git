...
import hotelfx.view.feature_room_check_fd.rctid.RCTICashController;
import hotelfx.view.feature_room_check_fd.rctid.RCTICekGiroController;
import hotelfx.view.feature_room_check_fd.rctid.RCTICreditCardController;
import hotelfx.view.feature_room_check_fd.rctid.RCTIDebitCardController;
import hotelfx.view.feature_room_check_fd.rctid.RCTIGuaranteePaymentController;
import hotelfx.view.feature_room_check_fd.rctid.RCTIReservationVoucherController;
import hotelfx.view.feature_room_check_fd.rctid.RCTITransferController;
...
public class RCTransactionInputDetailController implements Initializable {
    ...
    private List<RefFinanceTransactionPaymentType> loadAllDataFinanceTransactionPaymentType() {
        List<RefFinanceTransactionPaymentType> list = rcTransactionInputController.getParentController().getParentController().getServiceRV2().getAllDataFinanceTransactionPaymentType();
        for (int i = list.size() - 1; i > -1; i--) {
            if (list.get(i).getIdtype() == 13 //Open Deposit (Cash) = '13'
                ...
                if ((rcTransactionInputController.getParentController().calculationTotalRestOfBill()
                        .compareTo(new BigDecimal("0")) == 0)) {
//                        && list.get(i).getIdtype() != 0) { //Tunai = '0'
                    list.remove(i);
                } else {
                    if (rcTransactionInputController.getParentController().dataReservationBill.getTblBankCard() != null) {
    ...
    private void setTransactionTypeInputForm(RefFinanceTransactionPaymentType transactionType) {
        try {
            ...
            switch (transactionType.getIdtype()) {
                case 0:    //Tunai = '0'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTICash.fxml"));

                    RCTICashController rctiCashController = new RCTICashController(this);
                    loader.setController(rctiCashController);
                    break;
                case 1:    //Transfer = '1'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTITransfer.fxml"));

                    RCTITransferController rctiTransferController = new RCTITransferController(this);
                    loader.setController(rctiTransferController);
                    break;
                case 2:   //Debit Card = '2'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTIDebitCard.fxml"));
                ...
                case 3:  //Credit Card = '3'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTICreditCard.fxml"));
                    ...
                    break;
                case 4: //Cek = '4'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTICekGiro.fxml"));
                ...
                case 6:    //Travel Agent = '6'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTIGuaranteePayment.fxml"));
...
//                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTIDeposit.fxml"));
//
...
//                    break;
                case 10:   //Voucher = '10'
                    loader.setLocation(HotelFX.class.getResource("view/feature_room_check_fd/rctid/RCTIReservationVoucher.fxml"));

 ...
 */
package hotelfx.view.feature_retur.retur_receivable_and_payment.tid;
...
import hotelfx.view.feature_retur.retur_receivable_and_payment.HotelFinanceTransactionInputController;
import java.net.URL;
...
public class TIDCekGiroController implements Initializable {
    ...
    private void setSelectedDataToInputForm() {
        ...
        cbpBankAccount.valueProperty().bindBidirectional(hotelFinanceTransactionInputController.getParentController().selectedDataHFTWithCekGiro.tblBankAccountByReceiverBankAccountProperty());

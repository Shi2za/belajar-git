        ...
        if (checkDataInputDataSupplierBankAccount()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if (tidTransferController.getParentController().getParentController().getService().insertDataSupplierBankAccount(dummySelectedData) != null) {
                    ...
                    tidTransferController.getParentController().getParentController().selectedDataHFTWithTransfer.setTblBankAccountBySenderBankAccount(tidTransferController.selectedDataSupplierBankAccount.getTblBankAccount());

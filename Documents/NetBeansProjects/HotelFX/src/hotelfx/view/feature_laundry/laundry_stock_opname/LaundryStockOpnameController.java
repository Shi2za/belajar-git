 ...
 */
package hotelfx.view.feature_laundry.laundry_stock_opname;
 ...
 */
public class LaundryStockOpnameController implements Initializable {
...
//        AnchorPane.setLeftAnchor(cft, 15.0);
    ...
    private ObservableList<TblStockOpname> loadAllDataStockOpname() {
        ...
        for (int i = list.size() - 1; i > -1; i--) {
            ...
            if (list.get(i).getTblLocation().getRefLocationType().getIdtype() == 2) {    //Laundry = '2'
    ...
    private List<TblLocationOfLaundry> loadAllDataLocationOfLaundry() {
        List<TblLocationOfLaundry> list = parentController.getFStockOpnameManager().getAllDataLaundry();
        for (int i = list.size() - 1; i > -1; i--) {
            //data location
            list.get(i).setTblLocation(parentController.getFStockOpnameManager().getDataLocation(list.get(i).getTblLocation().getIdlocation()));
            //data location type
    ...
    private void setSelectedDataToInputForm() {
        ...
        cbpLocationOfLaundry.setValue(getDataLocationLaundry(selectedData.getTblLocation()));
    ...
    private TblLocationOfLaundry getDataLocationLaundry(TblLocation tblLocation) {
        if (tblLocation != null) {
            return parentController.getFLaundryManager().getDataLaundryByIdLocation(tblLocation.getIdlocation());
        }
        return null;
    }
        ...
        if (checkDataInputDataStockOpname()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                switch (dataInputStatus) {
                    case 0:
                        if (parentController.getFStockOpnameManager().insertDataStockOpnameLaundry(dummySelectedData,
    ...
    public LaundryStockOpnameController(FeatureLaundryController parentController) {

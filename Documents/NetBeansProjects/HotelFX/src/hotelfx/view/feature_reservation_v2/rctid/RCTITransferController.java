...
//        gpRCTITransfer.add(cbpReceiverBankAccount, 0, 3);
    ...
    private List<TblBankAccount> loadAllDataCustomerBankAccount() {
        List<TblCustomerBankAccount> cbaList = rcTransactionInputDetailController.getParentController().getParentController().getFReservationManager().getAllDataCustomerBankAccountByIDCustomer(rcTransactionInputDetailController.getParentController().getParentController().selectedData.getTblCustomer().getIdcustomer());
...
//        }
    ...
    private void showCustomerBankAccountDialog() {
        try {
            ...
            loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTITransferCustomerBankAccountInputDialog.fxml"));

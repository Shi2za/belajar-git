...
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTICashController;
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTICekGiroController;
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTICreditCardController;
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTIDebitCardController;
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTIGuaranteePaymentController;
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTIReservationVoucherController;
import hotelfx.view.feature_reservation_v2.rcr.rctid.RCRRCTITransferController;
import java.net.URL;
    ...
    private void setTransactionTypeInputForm(RefFinanceTransactionPaymentType transactionType) {
        try {
            ...
            switch (transactionType.getIdtype()) {
                case 0:    //Tunai = '0'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTICash.fxml"));

                    RCRRCTICashController rcrrctiCashController = new RCRRCTICashController(this);
                    loader.setController(rcrrctiCashController);
                    break;
                case 1:    //Transfer = '1'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTITransfer.fxml"));
                    ...
                    break;
                case 2:   //Debit Card = '2'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTIDebitCard.fxml"));
                ...
                case 3:  //Credit Card = '3'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTICreditCard.fxml"));
                    ...
                    break;
                case 4: //Cek = '4'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTICekGiro.fxml"));
                ...
                case 6:    //Travel Agent = '6'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTIGuaranteePayment.fxml"));
...
//                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTIDeposit.fxml"));
//
...
//                    break;
                case 10:   //Voucher = '10'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rcr/rctid/RCRRCTIReservationVoucher.fxml"));

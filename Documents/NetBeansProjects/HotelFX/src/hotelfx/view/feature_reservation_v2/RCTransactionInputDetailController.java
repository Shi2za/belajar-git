...
import hotelfx.view.feature_reservation_v2.rctid.RCTICashController;
import hotelfx.view.feature_reservation_v2.rctid.RCTICekGiroController;
import hotelfx.view.feature_reservation_v2.rctid.RCTICreditCardController;
import hotelfx.view.feature_reservation_v2.rctid.RCTIDebitCardController;
import hotelfx.view.feature_reservation_v2.rctid.RCTIGuaranteePaymentController;
import hotelfx.view.feature_reservation_v2.rctid.RCTIReservationVoucherController;
import hotelfx.view.feature_reservation_v2.rctid.RCTITransferController;
    ...
    private void setTransactionTypeInputForm(RefFinanceTransactionPaymentType transactionType) {
        try {
            ...
            switch (transactionType.getIdtype()) {
                case 0:    //Tunai = '0'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTICash.fxml"));

                    RCTICashController rctiCashController = new RCTICashController(this);
                    loader.setController(rctiCashController);
                    break;
                case 1:    //Transfer = '1'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTITransfer.fxml"));

                    RCTITransferController rctiTransferController = new RCTITransferController(this);
                    loader.setController(rctiTransferController);
                    break;
                case 2:   //Debit Card = '2'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTIDebitCard.fxml"));
                ...
                case 3:  //Credit Card = '3'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTICreditCard.fxml"));
                    ...
                    break;
                case 4: //Cek = '4'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTICekGiro.fxml"));
                ...
                case 6:    //Travel Agent = '6'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTIGuaranteePayment.fxml"));
...
//                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTIDeposit.fxml"));
//
...
//                    break;
                case 10:   //Voucher = '10'
                    loader.setLocation(HotelFX.class.getResource("view/feature_reservation_v2/rctid/RCTIReservationVoucher.fxml"));

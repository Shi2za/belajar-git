...
import hotelfx.view.feature_purchase_order.purchase_order_payable_and_payment.tid.TIDCashController;
import hotelfx.view.feature_purchase_order.purchase_order_payable_and_payment.tid.TIDCekGiroController;
import hotelfx.view.feature_purchase_order.purchase_order_payable_and_payment.tid.TIDTransferController;
...
public class HotelFinanceTransactionInputController implements Initializable {
        ...
        try {
            ...
            switch (transactionType.getIdtype()) {
                case 0:    //Tunai = '0'
                    ...
                    loader.setLocation(HotelFX.class.getResource("view/feature_purchase_order/purchase_order_payable_and_payment/tid/TIDCash.fxml"));
                ...
                case 1:    //Transfer = '1'
                    ...
                    loader.setLocation(HotelFX.class.getResource("view/feature_purchase_order/purchase_order_payable_and_payment/tid/TIDTransfer.fxml"));
                ...
                case 4: //Cek = '4'
                    ...
                    loader.setLocation(HotelFX.class.getResource("view/feature_purchase_order/purchase_order_payable_and_payment/tid/TIDCekGiro.fxml"));
    ...
    private boolean checkDataInputDataHotelFinanceTransactionWithCash() {
        ...
        if (purchaseOrderPayableController.selectedDataHFT.getTransactionNominal()
            ...
            BigDecimal maxCompanyBalance = purchaseOrderPayableController.selectedDataHFTWithCash.getTblCompanyBalance().getBalanceNominal();
            if (purchaseOrderPayableController.selectedDataHFT.getTransactionNominal().compareTo(maxCompanyBalance) == 1) {
                dataInput = false;
    ...
    private boolean checkDataInputDataHotelFinanceTransactionWithTransfer() {
        ...
        if (purchaseOrderPayableController.selectedDataHFT.getTransactionNominal()
            ...
            BigDecimal maxCompanyBalance = getMaxCompanyBalance(purchaseOrderPayableController.selectedDataHFTWithTransfer.getTblBankAccountBySenderBankAccount());
            if (purchaseOrderPayableController.selectedDataHFT.getTransactionNominal().compareTo(maxCompanyBalance) == 1) {
                dataInput = false;
                errDataInput += "Nominal Transaksi  : Nilai tidak dapat lebih besar " + ClassFormatter.currencyFormat.cFormat(maxCompanyBalance) + " (Total Nominal Kas Besar) \n";
            }
    ...
    private boolean checkDataInputDataHotelFinanceTransactionWithCekGiro() {
        ...
        if (purchaseOrderPayableController.selectedDataHFT.getTransactionNominal()
            ...
            BigDecimal maxCompanyBalance = getMaxCompanyBalance(purchaseOrderPayableController.selectedDataHFTWithCekGiro.getTblBankAccountBySenderBankAccount());
            if (purchaseOrderPayableController.selectedDataHFT.getTransactionNominal().compareTo(maxCompanyBalance) == 1) {
                dataInput = false;
                errDataInput += "Nominal Transaksi  : Nilai tidak dapat lebih besar " + ClassFormatter.currencyFormat.cFormat(maxCompanyBalance) + " (Total Nominal Kas Besar) \n";
            }
...
//        }
    ...
    public HotelFinanceTransactionInputController(PurchaseOrderPayableController parentController) {

 ...
 * @author ANDRI
 */
public class GovernmentBankAccountController implements Initializable {
...
//        }
    ...
    public GovernmentBankAccountController(GovernmentController parentController) {
        partnerController = parentController;
    }

    private final GovernmentController partnerController;

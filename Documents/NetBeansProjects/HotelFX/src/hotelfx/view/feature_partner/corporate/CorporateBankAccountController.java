 ...
 * @author ANDRI
 */
public class CorporateBankAccountController implements Initializable {
...
//        }
    ...
    public CorporateBankAccountController(CorporateController parentController) {
        partnerController = parentController;
    }

    private final CorporateController partnerController;

...
//        }
    ...
    private BigDecimal calculationMDRChargePayment() {
        BigDecimal result = new BigDecimal("0");
        TblBankEdcBankNetworkCard edcNetwrokCard = rcrrcTransactionInputController.getParentController().getParentController().getFReservationManager().getDataBankEDCBankNetworkCardByIDEDCAndIDNetworkCard(

...
//                txtServiceName.setText("");
        ...
        cbpReservationBillType.valueProperty().bindBidirectional(reservationController.selectedAdditionalService.refReservationBillTypeProperty());
                ...
                for (RTDListDate dataDate : tabelAdditionalDate.getItems()) {
                    if (dataDate.getSelectedDate()) {
                        ...
                        if (reservationController.selectedData.getRefReservationStatus().getIdstatus() == 1) {   //Reserved = '1' -> reservation bill
                            ...
                            setAdditionalServiceDiscount(dataAddtional, reservationController.dataCheckOutBill);
                        }
//                        dataAddtional.setNote("Jumlah Orang : 1");

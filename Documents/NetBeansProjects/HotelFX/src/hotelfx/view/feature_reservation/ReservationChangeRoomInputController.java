...
import hotelfx.view.feature_reservation.rcr.RCRReservationAdditionalServiceCreateBonusVoucherInputController;
import hotelfx.view.feature_reservation.rcr.RCRReservationRoomTypeDetailInputController;
...
//    @FXML
//    private Label lblPeriodeReservation;
...
//    @FXML
//    private JFXTextField txtTotalComplimetary;
...
//    private BigDecimal calculationRoomTypeDetailLastComplimentary(TblReservationRoomTypeDetail dataDetail) {
...
//            if (dataRTDRPD.getTblReservationRoomTypeDetail().equals(dataDetail)) {
...
//                    result -= data.getTblReservationRoomPriceDetail().getDetailComplimentary();
//                }
            }
        }
//        //data additional item
//        for (TblReservationAdditionalItem data : reservationController.dataReservationAdditionalItems) {
//            if (data.getTblReservationRoomTypeDetail().getIddetail() == reservationController.selectedDataRoomTypeDetail.getIddetail()
//                    && data.getRefReservationBillType().getIdtype() == 0 //Reservasi = '0'
//                    && !(LocalDateTime.of(data.getAdditionalDate().getYear() + 1900,
//                            data.getAdditionalDate().getMonth() + 1,
//                            data.getAdditionalDate().getDate(),
//                            reservationController.defaultCheckInTime.getHours(),
//                            reservationController.defaultCheckInTime.getMinutes(),
//                            0)).isBefore(reservationController.currentDateForChangeRoomProcess)) {
//                result += (1 - (data.getDiscountPercentage().doubleValue() / 100)) * (data.getItemCharge() * data.getItemQuantity().doubleValue());
//            }
//        }
//        //data additional service
//        for (TblReservationAdditionalService data : reservationController.dataReservationAdditionalServices) {
//            if (data.getTblReservationRoomTypeDetail().getIddetail() == reservationController.selectedDataRoomTypeDetail.getIddetail()
//                    && data.getRefReservationBillType().getIdtype() == 0 //Reservasi = '0'
//                    && !(LocalDateTime.of(data.getAdditionalDate().getYear() + 1900,
//                            data.getAdditionalDate().getMonth() + 1,
...
//                            reservationController.defaultCheckInTime.getMinutes(),
//                            0)).isBefore(reservationController.currentDateForChangeRoomProcess)) {
//                result += (1 - (data.getDiscountPercentage().doubleValue() / 100)) * (data.getPrice());
//            }
//        }
//        //data service charge
//        double serviceCharge = (reservationController.dataReservationBill.getServiceChargePercentage().doubleValue()) * (result);
//        //data tax
//        double tax = (reservationController.dataReservationBill.getTaxPercentage().doubleValue()) * (result + serviceCharge);
        //data total bill
//        return result + serviceCharge + tax;
        return result;
    }
...
//        //data additional item
//        for (TblReservationAdditionalItem data : reservationController.selectedAdditionalItems) {
//            result += (1 - (data.getDiscountPercentage().doubleValue() / 100)) * (data.getItemCharge() * data.getItemQuantity().doubleValue());
//        }
//        //data additional service
...
//    private BigDecimal calculationTotalComplementary() {
//        BigDecimal result = new BigDecimal("0");
//        //data reservation room price detail - last complimentary
////        if (rdbHotel.isSelected()) {
//        for (TblReservationRoomTypeDetailRoomPriceDetail data : reservationController.dataReservationRoomTypeDetailRoomPriceDetails) {
//            if (data.getTblReservationRoomTypeDetail().getIddetail() == reservationController.selectedDataRoomTypeDetail.getIddetail()
//                    && !(LocalDateTime.of(data.getTblReservationRoomPriceDetail().getDetailDate().getYear() + 1900,
...
//    }
    private BigDecimal calculationTotalAdditionalDiscount() {
        BigDecimal result = new BigDecimal("0");
        if (rdbHotel.isSelected()) {
//            if (calculationTotalBillNew() > (calculationTotalBillOld() - calculationTotalComplementary())) {
//                result = calculationTotalBillNew() - (calculationTotalBillOld() - calculationTotalComplementary());
//            }
...
//                - (calculationTotalBillOld() - calculationTotalComplementary())
//                - calculationTotalAdditionalDiscount();
        return calculationTotalBillNew()
...
//        lblPeriodeReservation.setText(getTextPeriode(reservationController.selectedDataRoomTypeDetail));
...
//        txtTotalComplimetary.setText(ClassFormatter.currencyFormat.cFormat(calculationTotalComplementary()));
...
//            if (reservationController.selectedDataTransactions.isEmpty()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                reservationController.refreshDataBill("checkout");
...
//            if (rdbCustomer.isSelected()
//                    && oldComplimentary == 0) {
//                dataRTDRPD.getTblReservationRoomPriceDetail().setDetailComplimentary((long) (0));
//            } else {
//                dataRTDRPD.getTblReservationRoomPriceDetail().setDetailComplimentary(
//                        (newPrice - (oldPrice - oldComplimentary)) < 0
//                                ? (long) 0
//                                : (long) (newPrice - (oldPrice - oldComplimentary)));
//            }
            if (rdbCustomer.isSelected()) {
...
//        //if with additional discount, then set data complementary
//        if (rdbHotel.isSelected()) {
//            for (TblReservationRoomTypeDetailRoomPriceDetail dataRTDRPD : reservationController.selectedDataRoomTypeDetailRoomPriceDetails) {
//                double newPrice = (1 - (dataRTDRPD.getTblReservationRoomPriceDetail().getDetailDiscountPercentage().doubleValue() / 100)) * dataRTDRPD.getTblReservationRoomPriceDetail().getDetailPrice();
//                double oldPrice = 0;
//                for (TblReservationRoomTypeDetailRoomPriceDetail data : reservationController.dataReservationRoomTypeDetailRoomPriceDetails) {
//                    if (data.getTblReservationRoomTypeDetail().getIddetail() == reservationController.selectedDataRoomTypeDetail.getIddetail()
//                            && (LocalDate.of(data.getTblReservationRoomPriceDetail().getDetailDate().getYear() + 1900,
...
//                                            dataRTDRPD.getTblReservationRoomPriceDetail().getDetailDate().getMonth() + 1,
//                                            dataRTDRPD.getTblReservationRoomPriceDetail().getDetailDate().getDate()))) {
//                        oldPrice += (1 - (data.getTblReservationRoomPriceDetail().getDetailDiscountPercentage().doubleValue() / 100)) * (data.getTblReservationRoomPriceDetail().getDetailPrice());
//                        oldPrice -= data.getTblReservationRoomPriceDetail().getDetailComplimentary();
//                        break;
//                    }
//                }
//                dataRTDRPD.getTblReservationRoomPriceDetail().setDetailComplimentary((long) (newPrice - oldPrice));
//            }
//        } else {  //just bring data complementary
//            for (TblReservationRoomTypeDetailRoomPriceDetail dataRTDRPD : reservationController.selectedDataRoomTypeDetailRoomPriceDetails) {
//                for (TblReservationRoomTypeDetailRoomPriceDetail data : reservationController.dataReservationRoomTypeDetailRoomPriceDetails) {
//                    if (data.getTblReservationRoomTypeDetail().getIddetail() == reservationController.selectedDataRoomTypeDetail.getIddetail()
//                            && (LocalDate.of(data.getTblReservationRoomPriceDetail().getDetailDate().getYear() + 1900,
...
//                                            dataRTDRPD.getTblReservationRoomPriceDetail().getDetailDate().getMonth() + 1,
//                                            dataRTDRPD.getTblReservationRoomPriceDetail().getDetailDate().getDate()))) {
//                        dataRTDRPD.getTblReservationRoomPriceDetail().setDetailComplimentary(data.getTblReservationRoomPriceDetail().getDetailComplimentary());
//                        break;
//                    }
//                }
//            }
...
//        if (!checkDataInputReservationAdditional()) {
//            dataInput = false;
//            errDataInput += "Data Tambahan (Barang/Layanan) : Terdapat kode reservasi kamar yang tidak sesuai..!! \n";
//        }
...
//    private boolean checkDataInputReservationAdditional() {
//        boolean dataInput = true;
//        for (TblReservationAdditionalItem data : reservationController.selectedAdditionalItems) {
//            if (data.getTblReservationRoomTypeDetail().getIddetail() != 0L) {
//                dataInput = false;
//                break;
//            }
//        }
...
//            for (TblReservationAdditionalService data : reservationController.selectedAdditionalServices) {
//                if (data.getTblReservationRoomTypeDetail().getIddetail() != 0L
//                        && data.getTblRoomService().getIdroomService() != 4) {  //Bonus Voucher = '4'
//                    dataInput = false;
//                    break;
//                }
//            }
...
//        TableColumn<TblReservationRoomTypeDetail, String> roomTypeDetailComplimentary = new TableColumn("Compliment");
//        roomTypeDetailComplimentary.setCellValueFactory((TableColumn.CellDataFeatures<TblReservationRoomTypeDetail, String> param)
//                -> Bindings.createStringBinding(() -> ClassFormatter.currencyFormat.cFormat(calculationRoomTypeDetailLastComplimentary(param.getValue())),
//                        param.getValue().lastUpdateDateProperty()));
//        roomTypeDetailComplimentary.setMinWidth(120);
        tableView.getColumns().addAll(codeDetail, roomTypeName,
                //                ioDateTitle, roomTypeDetailCost, roomTypeDetailDiscount, roomTypeDetailComplimentary);
...
//        //set table-control to content-view
////        ancTableReservationAdditionalItemLayout.getChildren().clear();
...
//
////        ancTableReservationAdditionalItemLayout.getChildren().add(tableDataReservationAdditionalItem);
//    }
//
...
//        totalAdditionalCharge.setMinWidth(140);
//
...
//                        param.getValue().idadditionalProperty()));
//        totalAdditionalDiscount.setMinWidth(140);
//
//        tableView.getColumns().addAll(codeDetail, additionalDate, itemName, itemQuantity, additionalCharge, totalAdditionalCharge, totalAdditionalDiscount);
...
//        return FXCollections.observableArrayList(reservationController.selectedAdditionalItems);
//    }
...
//        return FXCollections.observableArrayList(reservationController.selectedAdditionalServices);
...
//                    reservationController.selectedAdditionalItems.remove(i);
...
//                tableDataReservationAdditionalService.getTableView().setItems(FXCollections.observableArrayList(reservationController.selectedAdditionalServices));
    ...
    private void showReservationRoomTypeDetailDialog() {
        try {
            ...
            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRReservationRoomTypeDetailInputDialog.fxml"));
...
//     */
//    public TblReservationAdditionalItem tempSelectedAdditionalItem;
//
//    private void dataReservationAdditionalItemCreateHandle() {
//        if (tableDataReservationRoomTypeDetail.getTableView().getSelectionModel().getSelectedItems().size() == 1) {
//            //set selected data
//            tempSelectedAdditionalItem = new TblReservationAdditionalItem();
//            tempSelectedAdditionalItem.setTblReservationRoomTypeDetail((TblReservationRoomTypeDetail) tableDataReservationRoomTypeDetail.getTableView().getSelectionModel().getSelectedItem());
//            tempSelectedAdditionalItem.setItemCharge(new BigDecimal("0"));
//            tempSelectedAdditionalItem.setItemQuantity(new BigDecimal("0"));
...
//            tempSelectedAdditionalItem = (TblReservationAdditionalItem) tableDataReservationAdditionalItem.getTableView().getSelectionModel().getSelectedItem();
//            //open form data reservation additional item change room type detail dialog
//            showReservationAdditionalItemChangeRoomTypeDetailDialog();
//        } else {
//            ClassMessage.showWarningSelectedDataMessage("", reservationController.dialogStage);
//        }
//    }
...
//        if (tableDataReservationAdditionalItem.getTableView().getSelectionModel().getSelectedItems().size() == 1) {
//            tempSelectedAdditionalItem = (TblReservationAdditionalItem) tableDataReservationAdditionalItem.getTableView().getSelectionModel().getSelectedItem();
//            reservationController.selectedAdditionalItems.remove(tempSelectedAdditionalItem);
//            tableDataReservationAdditionalItem.getTableView().setItems(FXCollections.observableArrayList(reservationController.selectedAdditionalItems));
//            //refresh data bill
//            refreshBill();
//        } else {
...
//            // Load the fxml file and create a new stage for the popup dialog.
//            FXMLLoader loader = new FXMLLoader();
//            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRReservationAdditionalItemInputDialog.fxml"));
//
//            RCRReservationAdditionalItemInputController controller = new RCRReservationAdditionalItemInputController(this);
//            loader.setController(controller);
//
//            Region page = loader.load();
//
...
//    }
//
//    private void showReservationAdditionalItemChangeRoomTypeDetailDialog() {
//        try {
//            // Load the fxml file and create a new stage for the popup dialog.
//            FXMLLoader loader = new FXMLLoader();
//            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRReservationAdditionalItemChangeRoomTypeDetailInputDialog.fxml"));
//
//            RCRReservationAdditionalItemChangeRoomTypeDetailInputController controller = new RCRReservationAdditionalItemChangeRoomTypeDetailInputController(this);
//            loader.setController(controller);
//
//            Region page = loader.load();
//
...
//    public List<TblReservationAdditionalService> tempSelectedAdditionalServices;
//
...
//            tempSelectedAdditionalService.setTblReservationRoomTypeDetail((TblReservationRoomTypeDetail) tableDataReservationRoomTypeDetail.getTableView().getSelectionModel().getSelectedItem());
...
//            if (tempSelectedAdditionalService.getTblRoomService().getIdroomService() != 2 //early checkin = '2'
//                    && tempSelectedAdditionalService.getTblRoomService().getIdroomService() != 3 //late checkout = '3'
//                    && tempSelectedAdditionalService.getTblRoomService().getIdroomService() != 4) {  //bonus voucher = '4'
////            if (tempSelectedAdditionalService.getTblRoomService().getIdroomService() != 2   //early checkin = '2'
////                    && tempSelectedAdditionalService.getTblRoomService().getIdroomService() != 3) {  //late checkout = '3'
//                //open form data reservation additional service change room type detail dialog
//                showReservationAdditionalServiceChangeRoomTypeDetailDialog();
////            } else {
////                HotelFX.showAlert(Alert.AlertType.WARNING, "DATA TIDAK DAPAT DIHAPUS", "Data buatan sistem tidak dapat dihapus (tambahan biaya 'early checkin' atau 'late checkout')..!", "", reservationController.dialogStage);
////            }
//            } else {
//                HotelFX.showAlert(Alert.AlertType.WARNING, "DATA TIDAK DAPAT DIUBAH", "Data tambahan biaya 'early checkin', 'late checkout', atau voucher(bonus) tidak dapat diubah..!", "", reservationController.dialogStage);
//            }
//        } else {
//            ClassMessage.showWarningSelectedDataMessage("", reservationController.dialogStage);
//        }
...
//                refreshBill();
//            } else {
//                HotelFX.showAlert(Alert.AlertType.WARNING, "DATA TIDAK DAPAT DIHAPUS", "Data buatan sistem tidak dapat dihapus (tambahan biaya 'early checkin', 'late checkout', atau voucher(bonus))..!", "", reservationController.dialogStage);
//            }
//        } else {
//            ClassMessage.showWarningSelectedDataMessage("", reservationController.dialogStage);
//        }
...
//            // Load the fxml file and create a new stage for the popup dialog.
//            FXMLLoader loader = new FXMLLoader();
//            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRReservationAdditionalServiceInputDialog.fxml"));
//
//            RCRReservationAdditionalServiceInputController controller = new RCRReservationAdditionalServiceInputController(this);
//            loader.setController(controller);
//
//            Region page = loader.load();
//
...
//    }
//
//    private void showReservationAdditionalServiceChangeRoomTypeDetailDialog() {
//        try {
//            // Load the fxml file and create a new stage for the popup dialog.
//            FXMLLoader loader = new FXMLLoader();
//            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRReservationAdditionalServiceChangeRoomTypeDetailInputDialog.fxml"));
//
//            RCRReservationAdditionalServiceChangeRoomTypeDetailInputController controller = new RCRReservationAdditionalServiceChangeRoomTypeDetailInputController(this);
//            loader.setController(controller);
//
//            Region page = loader.load();
//
...
//    }
    ...
    private void showReservationAdditionalServiceCreateBonusVoucherDialog() {
        try {
            // Load the fxml file and create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRReservationAdditionalServiceCreateBonusVoucherInputDialog.fxml"));
...
//                        removeRCTransactionDetailData(data);
//                        //remove data rc-transaction
//                        reservationController.dataCheckOutPayments.remove(data);
//                        break;
//                    }
//                }
//            }
...
//            if (reservationController.dataInputTransactionStatus.equals("reservation")) {
                tableDataRCTransactionInputDetail.getTableView().setItems(FXCollections.observableArrayList(reservationController.selectedDataTransactions));
//            } else {  //checkout
//                tableDataRCTransactionInputDetail.getTableView().setItems(reservationController.loadAllDataCheckOutTransaction());
//            }
            }
        } else {
            ClassMessage.showWarningSelectedDataMessage(null, reservationController.dialogStage);
    ...
    private void showRCTransactionInputDetailDialog() {
        try {
            // Load the fxml file and create a new stage for the popup dialog.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(HotelFX.class.getResource("view/feature_reservation/rcr/RCRRCTransactionInputDialog.fxml"));
...
//        //data additional item
//        for (TblReservationAdditionalItem dataAdditionalItem : reservationController.selectedAdditionalItems) {
...
//                        ? dataAdditionalItem.getTblReservationRoomTypeDetail().getTblReservationCheckInOut().getTblRoom().getRoomName() : null);
...
//                dataGLID.setTotalDiscountNominal((long) ((dataAdditionalItem.getItemCharge() * dataAdditionalItem.getItemQuantity().doubleValue())
//                        * (dataAdditionalItem.getDiscountPercentage().doubleValue() / 100.0)));
//                dataGLID.setServiceChargePercentage(reservationController.dataReservationBill.getServiceChargePercentage());
//                dataGLID.setTaxPercentage(reservationController.dataReservationBill.getTaxPercentage());
...
//        }
//        //data additional service
//        for (TblReservationAdditionalService dataAdditionalService : reservationController.selectedAdditionalServices) {
...
//                        ? dataAdditionalService.getTblReservationRoomTypeDetail().getTblReservationCheckInOut().getTblRoom().getRoomName() : null);
//                dataGLID.setDetailDate(dataAdditionalService.getAdditionalDate());
//                dataGLID.setDetailCost(dataAdditionalService.getPrice());
//                dataGLID.setDetailQuantity(new BigDecimal("1"));
//                dataGLID.setTotalDiscountNominal((long) ((dataAdditionalService.getPrice() * 1)
//                        * (dataAdditionalService.getDiscountPercentage().doubleValue() / 100.0)));
//                dataGLID.setServiceChargePercentage(reservationController.dataReservationBill.getServiceChargePercentage());
//                dataGLID.setTaxPercentage(reservationController.dataReservationBill.getTaxPercentage());

...
//        }
    ...
    private void setSelectedDataToInputForm() {
        ...
        if(reservationController.selectedDataCheckIn.getTblRoom() != null){
            ...
            lblRoomStatusName.setText("Status : " + reservationController.selectedDataCheckIn.getTblRoom().getRefRoomStatus().getStatusName());
        }else{
    ...
    private void dataCheckInSaveHandle() {
        if (checkDataInputDataCheckIn()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if(reservationController.dataReservationSaveHandle(5)){
...
//        }
    ...
    public ReservationCheckInInputController(ReservationController parentController) {

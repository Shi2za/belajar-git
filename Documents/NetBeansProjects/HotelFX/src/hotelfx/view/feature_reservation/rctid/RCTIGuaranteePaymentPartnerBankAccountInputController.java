...
public class RCTIGuaranteePaymentPartnerBankAccountInputController implements Initializable {
    ...
    private void initDataPartnerBankAccountPopup() {
        ...
        ObservableList<TblBank> bankItems = FXCollections.observableArrayList(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getFReservationManager().getAllDataBank());
    ...
    private void dataPartnerBankAccountSaveHandle() {
        if (checkDataInputDataPartnerBankAccount()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if (rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getFReservationManager().insertDataPartnerBankAccount(dummySelectedData) != null) {
                    ...
                    rctiGuaranteePaymentController.selectedDataPartnerBankAccount = rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getFReservationManager().getDataPartnerBankAccount(dummySelectedData.getIdrelation());
                    rctiGuaranteePaymentController.selectedDataPartnerBankAccount.setTblPartner(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getFReservationManager().getPartner(rctiGuaranteePaymentController.selectedDataPartnerBankAccount.getTblPartner().getIdpartner()));
                    rctiGuaranteePaymentController.selectedDataPartnerBankAccount.setTblBankAccount(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getFReservationManager().getBankAccount(rctiGuaranteePaymentController.selectedDataPartnerBankAccount.getTblBankAccount().getIdbankAccount()));
                    ...
                    ClassMessage.showFailedInsertingDataMessage(rctiGuaranteePaymentController.getParentController().getParentController().getParentController().getFReservationManager().getErrorMessage(), rctiGuaranteePaymentController.dialogStage);
                }
            }
        } else {

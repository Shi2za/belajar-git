...
public class RCTITransferCustomerBankAccountInputController implements Initializable {
    ...
    private void initDataCustomerBankAccountPopup() {
        ...
        ObservableList<TblBank> bankItems = FXCollections.observableArrayList(rctiTransferController.getParentController().getParentController().getParentController().getFReservationManager().getAllDataBank());
    ...
    private void dataCustomerBankAccountSaveHandle() {
        if (checkDataInputDataCustomerBankAccount()) {
            ...
            if (alert.getResult() == ButtonType.OK) {
                ...
                if (rctiTransferController.getParentController().getParentController().getParentController().getFReservationManager().insertDataCustomerBankAccount(dummySelectedData) != null) {
                    ...
                    rctiTransferController.selectedDataCustomerBankAccount = rctiTransferController.getParentController().getParentController().getParentController().getFReservationManager().getDataCustomerBankAccount(dummySelectedData.getIdrelation());
                    rctiTransferController.selectedDataCustomerBankAccount.setTblCustomer(rctiTransferController.getParentController().getParentController().getParentController().getFReservationManager().getCustomer(rctiTransferController.selectedDataCustomerBankAccount.getTblCustomer().getIdcustomer()));
                    rctiTransferController.selectedDataCustomerBankAccount.setTblBankAccount(rctiTransferController.getParentController().getParentController().getParentController().getFReservationManager().getBankAccount(rctiTransferController.selectedDataCustomerBankAccount.getTblBankAccount().getIdbankAccount()));
                    ...
                    ClassMessage.showFailedInsertingDataMessage(rctiTransferController.getParentController().getParentController().getParentController().getFReservationManager().getErrorMessage(), rctiTransferController.dialogStage);
                }
            }
        } else {

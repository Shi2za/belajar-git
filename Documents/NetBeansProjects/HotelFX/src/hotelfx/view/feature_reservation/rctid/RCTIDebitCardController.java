...
//    private final JFXCComboBoxPopup<TblBankEventCard> cbpBankCardEvent = new JFXCComboBoxPopup<>(TblBankEventCard.class);
    ...
    private void initFormDataRCTIDebitCard() {
        ...
        chbGetRestOfBill.selectedProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal) {
                //set rest of bill
                totalBill.set(rcTransactionInputDetailController.getParentController().getParentController().calculationTotalRestOfBill(rcTransactionInputDetailController.getParentController().getParentController().dataInputTransactionStatus)
...
//        }
    ...
    private BigDecimal calculationMDRChargePayment() {
        BigDecimal result = new BigDecimal("0");
        TblBankEdcBankNetworkCard edcNetwrokCard = rcTransactionInputDetailController.getParentController().getParentController().getFReservationManager().getDataBankEDCBankNetworkCardByIDEDCAndIDNetworkCard(
...
//        ancCardEventLayout.getChildren().add(cbpBankCardEvent);
    ...
    private List<TblBankEdc> loadAllDataBankEDC() {
        List<TblBankEdc> list = rcTransactionInputDetailController.getParentController().getParentController().getFReservationManager().getAllDataBankEDC();
        for (TblBankEdc data : list) {
            ...
            //data bank account
            data.setTblBankAccount(rcTransactionInputDetailController.getParentController().getParentController().getFReservationManager().getBankAccount(data.getTblBankAccount().getIdbankAccount()));
        }
        return list;
    }
    ...
    private List<TblBankNetworkCard> loadAllDataBankNetworkCard() {
        ...
        if (rcTransactionInputDetailController.getParentController().getParentController().selectedDataTransactionWithBankCard.getTblBankEdc() != null) {
            List<TblBankEdcBankNetworkCard> listEDCNetworkCard = rcTransactionInputDetailController.getParentController().getParentController().getFReservationManager().getAllDataBankEDCBankNetworkCardByIDEDC(
                    rcTransactionInputDetailController.getParentController().getParentController().selectedDataTransactionWithBankCard.getTblBankEdc().getIdedc());
            for (TblBankEdcBankNetworkCard dataEDCNetworkCard : listEDCNetworkCard) {
                //data bank network card
                TblBankNetworkCard data = rcTransactionInputDetailController.getParentController().getParentController().getFReservationManager().getBankNetworkCard(dataEDCNetworkCard.getTblBankNetworkCard().getIdnetworkCard());
                //add data to list
                list.add(data);
            }
        }
...
//        cbpBankCardEvent.valueProperty().bindBidirectional(rcTransactionInputDetailController.getParentController().getParentController().selectedDataTransactionWithBankCard.tblBankEventCardProperty());
        ...
        if (rcTransactionInputDetailController.getParentController().getParentController().dataInputTransactionStatus.equals("reservation")
                && rcTransactionInputDetailController.getParentController().getParentController().dataReservationBill.getTblBankCard() != null) {
        ...
        if (rcTransactionInputDetailController.getParentController().getParentController().dataInputTransactionStatus.equals("checkout")
                && rcTransactionInputDetailController.getParentController().getParentController().dataCheckOutBill.getTblBankCard() != null) {
            cbpBank.setValue(rcTransactionInputDetailController.getParentController().getParentController().dataCheckOutBill.getTblBankCard().getTblBank());
            cbpBank.setDisable(true);
        }
        ...
        if (txtTotalBill.getText() == null 
            ...
            if (totalBill.get()
                ...
                if (totalBill.get()
                    ...
                    dataInput = false;
                    errDataInput += "Nominal Transaksi : Tidak dapat lebih besar dari '" + (rcTransactionInputDetailController.getParentController().getParentController().calculationTotalRestOfBill(
                            rcTransactionInputDetailController.getParentController().getParentController().dataInputTransactionStatus)
                            .add(rcTransactionInputDetailController.getParentController().getSelectedDataTransactionNominalMustBeReturn())) + "' \n";
                }
            }
...
//            }
    ...
    public RCTIDebitCardController(RCTransactionInputDetailController parentController) {

    ...
    private List<TblReservationVoucher> loadAllDataReservationVoucher() {
        ...
        for (int i = list.size() - 1; i > -1; i--) {
            ...
            if (list.get(i).getRefVoucherStatus().getIdstatus() != 1 //Ready to Used = '1'
                    ...
                    .compareTo((rcTransactionInputDetailController.getParentController().getParentController().calculationTotalBill(rcTransactionInputDetailController.getParentController().getParentController().dataInputTransactionStatus)
